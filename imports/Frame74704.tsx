...
import imgYuweenMainECom1 from "figma:asset/abb865c5beb14904fb184172f5a266f673eb6cb7.png";
import img111 from "figma:asset/02de003dbde6adfcfd8518a5a7133daff3be8f51.png";
import imgDashboard from "figma:asset/017b948ad0635b0c81bd33a7978ba490c1253ec9.png";
import imgHome from "figma:asset/aab625b7bd677dba9f8fbfb5544c68823513f2b0.png";
...
function APictureOfAVaseAndAMapOfTheUnitedStates() {
  return (
    <div
      className="bg-[#e5c98f] h-[540px] overflow-clip relative rounded-[34px] shrink-0 w-[962px]"
      data-name="A picture of a vase and a map of the United States."
    >
      <div
        className="[background-size:101.35%_100.25%] absolute bg-bottom bg-no-repeat h-[436px] left-1/2 rounded-[14px] translate-x-[-50%] translate-y-[-50%] w-[760px]"
        data-name="🏠   Dashboard 1"
        style={{
          top: "calc(50% + 61px)",
          backgroundImage: `url('${imgDashboard1}')`,
        }}
      >
...
function Frame74699() {
  return (
    <div className="box-border content-stretch flex flex-col gap-5 items-center justify-start p-0 relative shrink-0 w-full">
      <Frame74701 />
      <APictureOfAVaseAndAMapOfTheUnitedStates />
    </div>
  );
}
...
function Group74742() {
  return (
    <div className="absolute contents left-[188px] top-[-293px]">
      <div
        className="absolute bg-center bg-cover bg-no-repeat h-[891px] left-[188px] rounded-[14px] top-[100px] w-[267.97px]"
        data-name="Yuween Main eCom 1"
        style={{ backgroundImage: `url('${imgYuweenMainECom1}')` }}
      >
        <div className="absolute border-[#8b7969] border-[3px] border-solid inset-[-3px] pointer-events-none rounded-[17px]" />
      </div>
      <div
        className="absolute bg-center bg-cover bg-no-repeat h-[891px] left-[506px] top-[-293px] w-[267.97px]"
        data-name="Yuween Main eCom 2"
        style={{ backgroundImage: `url('${imgYuweenMainECom1}')` }}
      >
...
function APictureOfAVaseAndAMapOfTheUnitedStates1() {
  return (
    <div
      className="bg-[#584d43] h-[540px] overflow-clip relative rounded-[34px] shrink-0 w-full"
      data-name="A picture of a vase and a map of the United States."
    >
      <Group74742 />
    </div>
...
function Frame74705() {
  return (
    <div className="box-border content-stretch flex flex-col gap-5 items-center justify-start p-0 relative shrink-0 w-full">
      <Frame74702 />
      <APictureOfAVaseAndAMapOfTheUnitedStates1 />
    </div>
  );
}
...
function Group74745() {
  return (
    <div className="absolute contents left-[188px] top-[-466px]">
      <div
        className="absolute bg-center bg-cover bg-no-repeat h-[1041px] left-[188px] rounded-[14px] top-[100.67px] w-[268px]"
        data-name="11 1"
        style={{ backgroundImage: `url('${img111}')` }}
      >
        <div className="absolute border-[#98a5a0] border-[3px] border-solid inset-[-3px] pointer-events-none rounded-[17px]" />
      </div>
      <div
        className="absolute bg-center bg-cover bg-no-repeat h-[1041px] left-[506px] rounded-[14px] top-[-466px] w-[268px]"
        data-name="11 2"
        style={{ backgroundImage: `url('${img111}')` }}
      >
        <div className="absolute border-[#98a5a0] border-[3px] border-solid inset-[-3px] pointer-events-none rounded-[17px]" />
...
function APictureOfAVaseAndAMapOfTheUnitedStates2() {
  return (
    <div
      className="bg-[#5e766d] h-[540px] overflow-clip relative rounded-[34px] shrink-0 w-full"
      data-name="A picture of a vase and a map of the United States."
    >
      <Group74745 />
    </div>
...
function Frame74709() {
  return (
    <div className="box-border content-stretch flex flex-col gap-5 items-center justify-start p-0 relative shrink-0 w-full">
      <Frame74708 />
      <APictureOfAVaseAndAMapOfTheUnitedStates2 />
    </div>
  );
}
...
function Dashboard() {
  return (
    <div
      className="absolute bg-center bg-cover bg-no-repeat h-[457.571px] left-[102px] rounded-[14px] top-[100.848px] w-[493.475px]"
      data-name="Dashboard"
...
function Home() {
  return (
    <div
      className="absolute bg-center bg-cover bg-no-repeat h-[828.303px] left-[637.298px] rounded-[14px] top-[100.848px] w-[223.702px]"
      data-name="Home"
...
function APictureOfAVaseAndAMapOfTheUnitedStates3() {
  return (
    <div
      className="bg-[#595b89] h-[540px] overflow-clip relative rounded-[34px] shrink-0 w-full"
      data-name="A picture of a vase and a map of the United States."
    >
      <Group74748 />
    </div>
...
function Frame74713() {
  return (
    <div className="box-border content-stretch flex flex-col gap-5 items-center justify-start p-0 relative shrink-0 w-full">
      <Frame74712 />
      <APictureOfAVaseAndAMapOfTheUnitedStates3 />
    </div>
  );
}
...
export default function Frame74704() {
  return (
